package main.anticheat.spigot.exempt.type;
...
public enum ExemptType {
    ...
    PICKED_UP_ITEM(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastItemPickup() < 30),
    ANVIL(data -> data.getPositionProcessor().isNearAnvil()),
    LAGGED_NEAR_GROUND_(data -> ServerUtil.isHigherThan1_13() && data.getConnectionProcessor().getFlyingDelay() < 10L && (data.getPositionProcessor().isNearGround() || data.getPositionProcessor().isAirBelow())),
    FULLY_SUBMERGED(data -> data.getPositionProcessor().isFullySubmerged()),
    RESPAWN(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastRespawn() < 20),
    ...
    SLEEPING(data -> data.getPlayer().isSleeping() || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastBedEnter() < 40 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastBedLeave() < 40),
    ...
    PLUGIN_LOAD(data -> System.currentTimeMillis() - Anticheat.INSTANCE.getStartTime() < 10000L),
    ...
    DIGGING(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastDiggingTick() < 20 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastBukkitDiggingTick() < 20),
    ...
    WINDOW_CLICK(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastWindowClick() < 15),
    DROPPED_ITEM(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastDropItemTick() < 15),
    CANCELLED_BREAK(data -> Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastCancelledBreak() < 40),
    ...
    AUTOCLICKER_NON_DIG(data -> data.getExemptProcessor().isExempt(ExemptType.PLACING, ExemptType.DIGGING, ExemptType.BLOCK_BREAK, ExemptType.FAST, ExemptType.DROPPED_ITEM, ExemptType.WINDOW_CLICK, ExemptType.CANCELLED_BREAK, ExemptType.CREATIVE) || data.getActionProcessor().getSinceGlassBottleFillTicks() < 15 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getCombatProcessor().getLastItemFrame() < 20 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastProjectileThrow() < 20),
    AUTOCLICKER(data -> data.getExemptProcessor().isExempt(ExemptType.PLACING, ExemptType.DIGGING, ExemptType.BLOCK_BREAK, ExemptType.FAST, ExemptType.DROPPED_ITEM, ExemptType.WINDOW_CLICK, ExemptType.CREATIVE, ExemptType.CANCELLED_BREAK) || System.currentTimeMillis() - data.getActionProcessor().getLastStartDestroy() < 110L || data.getPositionProcessor().getSinceFireworkTicks() < 20 || System.currentTimeMillis() - data.getClickProcessor().getLastInteractEntity() < 250L || data.getActionProcessor().getSinceGlassBottleFillTicks() < 15 || System.currentTimeMillis() - data.getActionProcessor().getLastAbort() < 110L || System.currentTimeMillis() - data.getActionProcessor().getLastStopDestroy() < 110L || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastFishEvent() < 20 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getActionProcessor().getLastProjectileThrow() < 20 || Anticheat.INSTANCE.getTickManager().getTicks() - data.getCombatProcessor().getLastItemFrame() < 20 || (data.getActionProcessor().getDistanceFromLastAbort() < 6.5 && data.getActionProcessor().getDistanceFromLastAbort() > 0.0)),

...
public final class PlayerUtil {
    ...
    public static List<Material> getBlocksAboveGlitched(final PlayerData data) {
    ...
    public static void rotateRandomly(final Player player) {
        ...
        Bukkit.getScheduler().runTask(Anticheat.INSTANCE.getPlugin(), () -> player.teleport(location, PlayerTeleportEvent.TeleportCause.UNKNOWN));
    }

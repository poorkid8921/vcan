package main.anticheat.spigot.util.value;
...
public final class Values {
    ...
    static {
        ...
        JUMP_MOTION = new HashMap<>();
        JUMP_MOTION_DOWN = new HashMap<>();
        SENSITIVITY_MCP_VALUES = new HashMap<>();
        BLOCK_HARDNESS_VALUES = new HashMap<>();

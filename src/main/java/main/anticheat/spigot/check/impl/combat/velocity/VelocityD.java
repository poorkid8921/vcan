package main.anticheat.spigot.check.impl.combat.velocity;
...
import main.anticheat.spigot.data.processor.VelocityProcessor;
import main.anticheat.spigot.exempt.type.ExemptType;
import main.anticheat.spigot.packet.Packet;
import main.anticheat.spigot.util.nms.MathHelper;
                                    ...
                                    for (int slowdownIter = 0; slowdownIter < 2; ++slowdownIter) {
                                        for (int jumpIter = 0; jumpIter < 2; ++jumpIter) {
                                            ...
                                            if (diagonal > 1.0E-4f) {
                                                ...
                                                final float f2 = MathHelper.sin(rotationYaw * 3.141592653589793f / 180.0f);
                                                final float f3 = MathHelper.cos(rotationYaw * 3.141592653589793f / 180.0f);
